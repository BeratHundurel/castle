                ...
                .on_ok({
                    ...
                    move |_, window, cx| {
                        let Some(list_id) = select
                            ...
                            window
                                .push_notification(Notification::error("Choose a board list."), cx);
                            return false;
                        };
                            ...
                            cx.spawn_in(window, async move |_, window| {
                                ...
                                window
                                    .update(|window, cx| match result {
                                        ...
                                        Ok(Err(error)) => window.push_notification(
                                            Notification::error(format!(
                                                "Could not create card: {error}"
                                            )),
                                            cx,
                                        ),
                                        Err(error) => window.push_notification(
                                            Notification::error(format!(
                                                "Could not finish creating card: {error}"
                                            )),
                                            cx,
                                        ),
                                    })
                    ...
                    DialogHeader::new()
                        ...
                        .child(
                            DialogDescription::new()
                                .child("The note stays unchanged and is linked to the new card."),
                        ),
                )
                .child(
                    v_flex()
