...
impl Render for BoardView {
    fn render(&mut self, _: &mut Window, cx: &mut Context<Self>) -> impl IntoElement {
        let board = div()
            ...
            .size_full()
            .overflow_hidden()
            .on_action(cx.listener(Self::on_add_board_card_action))
            .on_action(cx.listener(Self::on_add_board_list_action))
            .on_action(cx.listener(Self::on_select_board_up_action))
            .on_action(cx.listener(Self::on_select_board_down_action))
            .on_action(cx.listener(Self::on_select_board_left_action))
            .on_action(cx.listener(Self::on_select_board_right_action))
            .on_action(cx.listener(Self::on_open_selected_board_item_action))
            .on_action(cx.listener(Self::on_clear_board_selection_action))
            .on_action(cx.listener(Self::on_delete_selected_board_item_action))
